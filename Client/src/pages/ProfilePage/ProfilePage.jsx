...
export default ProfilePage;
  ...
  //     <Nav />
  //     <main className="profile-main">
  //       <h1 className="brand-title">PETGRAM</h1>
...
//         if (data.user.profilePic?.data) {
//           const base64Image = `data:${data.user.profilePic.contentType};base64,${btoa(
//             String.fromCharCode(...new Uint8Array(data.user.profilePic.data.data))
//           )}`;
//           data.user.profilePic = base64Image;
//         } else {
//           data.user.profilePic = "https://placehold.co/100x100";
//         }
...
//   if (!profileData.user.username) return <div>Loading profile...</div>;
...
//         <div className="profile-header">
//           <img src={profileData.user.profilePic} alt="Profile" className="profile-pic" />
//           <div className="username-box">{profileData.user.username}</div>
//         </div>
...
//         <div className="posts-grid">
//           {profileData.posts.map((post, i) => (
//             <img key={i} src={post.imageUrl} className="post-preview" alt={`Post ${i}`} />
//           ))}
//         </div>
...
//   // Example user data and posts (replace with props or API)
//   const { currentUser } = useAuth();
//   const name = currentUser.uid;
//   const username = user?.name || "User Name";
//   const profilePic = user?.profilePic || "https://via.placeholder.com/100";
//   const posts = user?.posts || [1, 2, 3]; // Replace with actual image URLs
...
//           <div className="username-box">{name}</div>
//         </div>
